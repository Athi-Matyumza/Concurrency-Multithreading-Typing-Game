...
public class GamePanel extends JPanel implements Runnable {
		...
		private FallingWord[] words, wordsH;
		private int noWords;
		private final static int borderWidth=25; //appearance - border

		GamePanel(FallingWord[] words, FallingWord[] wordsH, int maxY,
		...
		public void paintComponent(Graphics g) {
		   ...
		   //draw the words
		    if (!started.get()) {
				...
				g.drawString(wordsH[0].getWord(), wordsH[0].getX(), wordsH[0].getY());// DRAWING THE HORIZONTAL WORDS
